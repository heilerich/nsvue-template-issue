...
declare class UIView extends UIResponder implements CALayerDelegate, NSCoding, UIAccessibilityIdentification, UIAppearance, UIAppearanceContainer, UICoordinateSpace, UIDynamicItem, UIFocusItem, UIFocusItemContainer, UILargeContentViewerItem, UITraitEnvironment {
	...
	makeToastActivity(position: any): void;

	makeToastDurationPosition(message: string, duration: number, position: any): void;

	makeToastDurationPositionStyle(message: string, duration: number, position: any, style: CSToastStyle): void;

	makeToastDurationPositionTitleImageStyleCompletion(message: string, duration: number, position: any, title: string, image: UIImage, style: CSToastStyle, completion: (p1: boolean) => void): void;
	...
	showToast(toast: UIView): void;

	showToastDurationPositionCompletion(toast: UIView, duration: number, position: any, completion: (p1: boolean) => void): void;
	...
	toastViewForMessageTitleImageStyle(message: string, title: string, image: UIImage, style: CSToastStyle): UIView;
